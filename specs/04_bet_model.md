...
Landscape lesson: `research/landscape/landscape.html` and `research/landscape/landscape_c.html` show that the market has many idea generators, signal collectors, and spec writers, but the weak middle is structured Bet framing from raw demand signals. This file defines that middle.
