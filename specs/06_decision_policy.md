...
Landscape lesson: `research/landscape/landscape_b.html` and `research/landscape/landscape_c.html` show that signal ingestion, synthesis, scoring, spec output, and feedback loops are unwired. This policy is the connective gate: evidence-backed decision first, spec second.
